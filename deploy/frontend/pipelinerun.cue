...
// cv_frontend's registry facts — the ONE place both hostnames live.
...
// addresses the same repo over the loopback NodePort. The manifest digest
// is identical either way. `cue export -e image.host` hands the operator
// the loopback form.
#image: {
